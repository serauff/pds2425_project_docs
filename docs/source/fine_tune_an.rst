...
Then we use the same logic as described in :doc:`data_generation` to create new Question-Answer pairs with our synthetic questionnaires. This results in 2266 Question-Answer pairs that are ready to be annotated by our fine-tuned models in the :ref:`annotator:` section.
