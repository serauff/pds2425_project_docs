...
After JSON outputs are generated by passing a chat message and the initialised chat to the :py:func:`data_gen.generate_with_msg` multiple times, the structure of the outputs are cleaned with regEx as long as deemed useful and afterwards get manually refined.
